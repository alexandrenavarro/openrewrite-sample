...
//activeRecipe("org.openrewrite.java.cleanup.ExternalizableHasNoArgsConstructor")                                                   // ,cleanup, yes, 9, ?, ?, no effect on a big project, to be tested
//activeRecipe("org.openrewrite.java.cleanup.ForLoopIncrementInUpdate")                                                             // ,cleanup, yes, 0, ?, ?, no effect on a big project, to be tested
